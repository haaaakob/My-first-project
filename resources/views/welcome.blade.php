...
{{--                            <a href="{{ route('registration', app()->getLocale()) }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a>--}}
{{--                        @endif--}}
{{--                    @endauth--}}
{{--                </div>--}}
            <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
...
{{--                        </li>--}}
{{--                        <li class="nav-item">--}}
{{--                            <a href="" style="text-decoration: none" class="nav-item">Հայերեն</a>--}}
...
{{--                        </li>--}}
                        ...
                        <li class="nav-item">
                            <a href="en" style="text-decoration: none" class="nav-item">English</a>
                        </li>
                        <li class="nav-item">
                            <a href="am" style="text-decoration: none" class="nav-item">Հայերեն</a>
                        </li>
                        <li class="nav-item">
                            <a href="ru" style="text-decoration: none" class="nav-item">Русский:</a>
                        </li>
